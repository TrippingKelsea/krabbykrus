//! Command-line interface for Krabbykrus
...
/// Krabbykrus: Next-generation AI agent framework
#[derive(Parser)]
#[command(name = "krabbykrus")]
...
pub enum GatewayCommands {
    ...
    Install {
        ...
        system: bool,
        /// Custom service name
        #[arg(long, default_value = "krabbykrus-gateway")]
        name: String,
    },
...
pub enum CredentialsCommands {
    ...
    Init {
        ...
        #[arg(short, long)]
        password: bool,
        /// Use a specific key file (default: ~/.config/krabbykrus/vault.key)
...
pub enum MigrateCommands {
    ...
    Verify {
        ...
        /// Krabbykrus config file
        krabbykrus_config: Option<PathBuf>,
    },
}
...
pub async fn run(cli: Cli) -> Result<()> {
    ...
    let filter = EnvFilter::try_from_default_env()
        .unwrap_or_else(|_| EnvFilter::new(format!("krabbykrus={}", log_level)));
